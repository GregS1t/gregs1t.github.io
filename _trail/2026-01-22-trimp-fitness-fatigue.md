...
For a French-speaking audience, I highly recommend the work of Cyril Forestier on the _Courir Mieux_ podcast, particularly his episode on [training load in trail running](https://courir-mieux.fr/charge-dentrainement-trail).
...
Eric Banister proposed quantifying each session with a **Tr**aining **IMP**ulse:
...
The models above have parameters **fixed a priori**. As discussed in the Minetti Model article, the natural next step is to **estimate them on your own data**, by observing how your performance responds to load.
